...
const domain1: DomainConfigPort = {
  sources: { enabled: [] },
  prompts: [],
  skills: { active: [] },
  hooks: { toolWhitelist: ["search", "fetch"] },
  rag: { adapter: "default" },
};
...
const domain2: DomainConfigPort = {
  sources: { enabled: [] },
  prompts: [],
  skills: { active: [] },
  hooks: { toolWhitelist: [] },
...
const domain3: DomainConfigPort = {
  sources: { enabled: [] },
  prompts: [],
  skills: { active: [] },
  hooks: { toolWhitelist: ["search", "nonexistent"] },
  rag: { adapter: "default" },
};
