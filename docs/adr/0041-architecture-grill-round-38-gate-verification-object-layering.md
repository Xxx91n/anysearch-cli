...
1. On a clean machine (no ~/.anysearch/anysearch.db) ship-gate step 1 no longer reports skip; results show object=gate-built and the ledger logs pass. <!-- machine-local: 用户级 ~ 路径引用（存量合规化） @ 2026-09-22 -->
