...
The complete numbered record lives in `docs/adr/` — ADR-0001 through ADR-0069.
...
| [0068](docs/adr/0068-architecture-grill-round-67-codex-01425-host-contract-envelope.md) | Grill Round 67 — Codex 0.142.5 真宿主契约对齐（官方 schema + 全信封输出 + 权限传递） |
| [0069](docs/adr/0069-architecture-grill-round-68-release-gate-dual-layer-closeout-lint.md) | Grill Round 68 — Release Gate 双层化（pre-tag 自等 + post-tag 前置断言）与收口必填栏 lint |
<!-- END ADR-INDEX -->
